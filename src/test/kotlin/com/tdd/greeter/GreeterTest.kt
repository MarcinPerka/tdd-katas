...
class GreeterTest {
    ...
    @ParameterizedTest
    @CsvSource(value = ["Marcin:Hello Marcin", "Adam: Hello Adam", "Leszek: Hello Leszek"], delimiter = ':')
    ...
    @ParameterizedTest
    @CsvSource(value = [" Michał:Hello Michał", "Konrad : Hello Konrad", " Tomek : Hello Tomek"], delimiter = ':')
    ...
    @ParameterizedTest
    @CsvSource(value = [" jacek:Hello Jacek", "katarzyna : Hello Katarzyna", " tomek : Hello Tomek"], delimiter = ':')
